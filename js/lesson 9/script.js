...
for (let course of coursesArray) {
    ...
    for (let courseItem in course) {
        if (Array.isArray(course[courseItem])) {
            let div = document.createElement("div");
            divCourse.append(div);
            for (let courseItemKey of course[courseItem]) {
                let divModules = document.createElement("div");
                div.append(divModules);
                divModules.innerText = courseItemKey;
            }
        } else {
            let div = document.createElement("div");
            divCourse.append(div);
            div.innerText = course[courseItem];
        }
    }
}
...
document.body.append(buttonDisappear);
buttonDisappear.innerText = "Click me";
buttonDisappear.onclick = function () {
    let blockAnyElement = document.getElementById("text");
    blockAnyElement.remove("none");
};
